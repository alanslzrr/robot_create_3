...
├── PRM01_P02.py          # Script principal Parte 02 (potencial combinado con waypoints)
...
**Navegación con waypoints secuenciales:**
...
python PRM01_P02.py --potential linear
python PRM01_P02.py --potential quadratic
python PRM01_P02.py --potential exponential
