...
# Ejemplo: detección de "precipicio" (cliff) mediante eventos de los 4 sensores.
# - Se imprime cuál sensor detectó borde: Izquierda, Frente Izq., Frente Der., Derecha.
# - Si todos detectan al mismo tiempo, se avisa que hay un precipicio.
